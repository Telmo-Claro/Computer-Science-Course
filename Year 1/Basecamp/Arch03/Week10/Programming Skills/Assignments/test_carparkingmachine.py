...
def test_check_in_capacity():
    ...
    assert True == all(car in cpm_north.parked_cars for car in ('XXX','YYY'))
...
def test_check_in_capacity():
    ...
    assert True == all(car in cpm_north.parked_cars for car in ('XXX','YYY')), "Check if XXX and YYY are in the list of parked_cars"