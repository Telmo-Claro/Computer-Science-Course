    ...
    for i, row in enumerate(map_list):
        if i == row_index_player1 == row_index_player2:
            if column_index_player1 == column_index_player2:
                if i == 0 or i == 9:
                    row = row[:column_index_player1] + Fore.GREEN + 'X' + reset + Fore.RED + 'O' + reset + row[column_index_player1 + 1:]
                else:
                    row = row[:column_index_player1] + Fore.GREEN + 'X' + reset + Fore.RED + 'O' + reset + ']' + row[column_index_player1 + 3:]
            else:
                if i == 0 or i == 9:
                    row = row[:column_index_player1] + Fore.GREEN + 'X' + reset + row[column_index_player1 + 1:]
                    row = row[:column_index_player2] + Fore.RED + 'O' + reset + row[column_index_player2 + 1:]
                else:
                    row = row[:column_index_player1] + Fore.GREEN + 'X' + reset + ']' + row[column_index_player1 + 2:]
                    row = row[:column_index_player2] + Fore.RED + 'O' + reset + ']' + row[column_index_player2 + 2:]
